...
export default async function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-bold text-gray-900">Cấu Hình Tài Khoản &amp; Hệ Thống</h1>
        <p className="text-xs text-gray-500 mt-1">
          Quản lý thông tin tài khoản, đổi mật khẩu cá nhân và xem lịch sử các thao tác hệ thống.
        </p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left Column: Org Info & Change Password Form */}
        <div className="space-y-6">
          {/* Organization Info */}
            ...
            <table className="w-full text-left text-xs text-gray-600">
              <thead className="bg-gray-50 font-semibold text-gray-500 sticky top-0">
                <tr>
                  ...
                  <th className="px-3 py-2">Thực thể</th>
                </tr>
              </thead>
